...
const Banner = () => {
    return (
        <div className='w-full flex flex-col md:flex-row items-center justify-center bg-[#4a000a] rounded-lg shadow-lg p-4'>
            ...
            <h2 className='text-3xl md:text-4xl lg:text-5xl text-white leading-tight'>Find something</h2>
            <h2 className='text-3xl md:text-4xl lg:text-5xl text-white leading-tight'>just as unique</h2>
            <h2 className='text-3xl md:text-4xl lg:text-5xl text-white leading-tight'>as you</h2>
