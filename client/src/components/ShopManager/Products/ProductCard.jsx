...
const ProductCard = ({
  ...
  return (
    <div className="relative card border border-gray-300 overflow-hidden rounded-lg">
      <Link
        to={`/shopmanager/${user._id}/editproduct/${_id}`}
        className="block"
      >
        <img
          src={image_urls[0]}
          alt={`No image available for ${productName}`}
          className="w-full h-48 object-cover transition-transform duration-300 transform hover:scale-105 hover:z-10"
        />
        <div className="p-4">
