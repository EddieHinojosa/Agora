  ...
  const onDelete = async (_id) => {
    try {
      const response = await axios.delete(
        ...
        }/shopmanager/${user._id}/products/${_id}
                      `
      );
  ...
  return (
    <div className="min-h-screen container mx-auto p-4">
      <div className="flex items-center mb-4">
        ...
        <Link
          to={`/shopmanager/${user._id}/newproduct`}
          className="ml-auto text-l flex items-center border border-gray-300 rounded-lg px-4 py-2 hover:bg-black hover:text-white"
        >
      ...
      <div className="flex justify-end mt-2">
        <div className="w-full flex p-1 space-x-4 items-center">
          <button className="p-2 hover:underline border border-gray-300 rounded-md">
            Sort A-Z
          </button>
