...
const NewProduct = () => {
    ...
    <div className="w-full flex flex-col space-y-4">
      ...
      <div className="flex space-x-4">
        <div className="flex mt-5">
          ...
          />
          <label htmlFor="physicalItem" className="ml-2 block text-sm text-gray-700">
            Physical Item
          </label>
        </div>
        <div className="flex mt-5">
          <input
            ...
            className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
          />
          <label htmlFor="digitalItem" className="ml-2 block text-sm text-gray-700">
            Digital Item
          </label>
        </div>
      </div>
      ...
      {/* Item Tags */}
      <div>
        <label htmlFor="itemTags" className="block text-sm font-medium text-gray-700">
          Item Tags
        </label>
        <input
          type="text"
  ...
  const ProductPricing = () => (
    <div>
      ...
      {/* Price */}
      <div>
        <label htmlFor="price" className="mt-14 block text-sm font-medium text-gray-700">
          Price
        </label>
      ...
      {/* Quantity */}
      <div>
        <label htmlFor="quantity" className="mt-6 block text-sm font-medium text-gray-700">
          Quantity
        </label>
        <input
          type="text"
  ...
  const ProductDimensions = () => (
    <div>
      {/* Length */}
      <div>
        <label htmlFor="length" className="mt-14 block text-sm font-medium text-gray-700">
          Length
        </label>
      ...
      {/* Width */}
      <div>
        <label htmlFor="width" className="mt-4 block text-sm font-medium text-gray-700">
          Width
        </label>
        <div className="flex items-center mt-1">
          <input
      ...
      {/* Height */}
      <div>
        <label htmlFor="height" className="mt-4 block text-sm font-medium text-gray-700">
          Height
        </label>
        <div className="flex items-center mt-1">
          <input
      ...
      {/* Weight */}
      <div>
        <label htmlFor="weight" className="mt-4 block text-sm font-medium text-gray-700">
          Weight
        </label>
        <div className="flex items-center mt-1">
          <input
...
// Previous Code, keeping it here for right now, just in case -Clarissa
