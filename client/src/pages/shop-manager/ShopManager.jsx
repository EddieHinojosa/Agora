          ...
          <div className="min-h-screen">
            ...
            <div className="flex justify-center items-center mt-8">
              <StatusCard
                ...
                count={productCounts.activeCount}
              />
              <StatusCard
                status="Total Quantity"
                count={productCounts.totalCount}
              />
              <StatusCard
                status="Sold Out"
                count={productCounts.soldOutCount}
              />
            </div>
            <div className="flex justify-center mt-8">
              {!userData.shopShippingAddress && !userData.shopDescription && (
                <h2>
                  Please Enter Shop Shipping Address and Shop Description.
                </h2>
              )}
              {!userData.shopShippingAddress && userData.shopDescription && (
            ...
            <div className="flex justify-center">
              {settingUpdate && (
                <Link
                  to={`/shopmanager/${id}/settings`}
                  className="mt-2 px-4 py-2 bg-black text-white text-sm rounded hover:bg-gray-300 hover:text-black"
                >
                  Shop Settings
                </Link>
              )}
