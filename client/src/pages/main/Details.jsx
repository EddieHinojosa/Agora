    ...
    <div className="min-h-screen flex flex-col md:flex-row items-start mt-6 pl-6 pr-6 md:pl-24 md:pr-20">
      ...
      <div className="w-full md:w-1/2 mt-4 md:mt-0 md:ml-6 flex flex-col justify-start">
        <div className="mb-4">
          ...
          <p className="text-lg w-1/2 text-gray-700 mt-2">
          ...
          <div className="mt-4">
            <Link
              to={`/shop/${slug(product.shopName) || "shop"}`}
              className="text-sm rounded-md text-gray-700 hover:bg-gray-300 hover:text-black hover:p-2"
            >
          ...
          <button
            ...
            className="mt-4 px-4 py-2 w-full md:w-1/2  bg-black text-white text-sm font-semibold rounded-md hover:bg-gray-300 hover:text-black"
          >
            Add to Cart
          </button>
          ...
          <div className="mt-6">
            ...
            {showAbout && (
              <>
                <p className="w-1/2 text-lg text-gray-700 mt-2">
            ...
            {showSpec && (
              <>
                ...
                <ul className="list-disc list-inside mt-2 text-gray-700 text-md">
                  ...
                  <li>
                    Product Dimensions: {product.productLength} x{" "}
                    {product.productWidth} x {product.productHeight}
                  </li>
                  <li>
                    Packed Dimensions: {product.packedLength} x{" "}
                    {product.packedWidth} x {product.packedHeight}
                  </li>
